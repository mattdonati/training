...
# This training script was changed from the first time I tried to run this on gke using helm and gpu recipes. 
...
def get_rank():
    return int(os.getenv("RANK")) # global rank
...
def main(cfg: DictConfig) -> None:
    ...
    tokenizer = AutoTokenizer("/peft/data/data/model/context/nemo_tokenizer/")
